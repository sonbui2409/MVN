...
public class LoginObject extends BaseActions {
	...
	public LoginObject Login(ExtentTest log, WebDriver driver) {
		/*
		 * GotoURL(log, driver, url); InputdataXpath(log, driver, user,
		 * "standard_user"); InputdataXpath(log, driver, passbut, passwd);
	...
	public LoginObject Verify_fail_1(ExtentTest log, SoftAssert softAssert, WebDriver driver) {
		sAssertEqual(log, softAssert, driver, readExl("Xpath", DataTest.ColXpath, 4),
	...
	public LoginObject Verify_fail_2(SoftAssert softAssert, WebDriverWait wait, ExtentTest log, WebDriver driver) {
		...
		GetTextEqual(softAssert, log, driver, readExl("Xpath", DataTest.ColXpath, 4),
	...
	public LoginObject LoginFail_1(ExtentReports report, ExtentTest log, WebDriver driver) {
